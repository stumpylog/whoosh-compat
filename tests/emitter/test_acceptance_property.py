...
own emit() raises a documented `UnsupportedQueryError`/`QueryEmitError`
...
# UnsupportedQueryError at emit time for exactly those fields, a genuine
...
def _acceptance_property(q: str, windex_prop: WhooshIndex, tindex_prop: TIndex) -> None:
    ...
    except (UnsupportedQueryError, QueryEmitError):

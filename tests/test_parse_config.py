...
def test_field_boost_key_resolves_alias_to_canonical_field(reg):
...
def test_field_boost_key_by_canonical_name_still_works(reg):
    r = wc.parse(
        "hello",
        registry=reg,
        default_fields=["content", "document_type"],
